...
class ChessEngineSpec extends Specification {
    ...
    public static class TestEngine extends ChessEngine {

        TestEngine(PlayerProvider<ChessEngine> playerProvider, String wrapperInput) {
    ...
    def "test if ChessEngine is created"() {
        ...
        expect:
        finalState instanceof ChessState;

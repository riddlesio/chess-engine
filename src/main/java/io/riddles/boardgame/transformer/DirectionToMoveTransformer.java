...
public final class DirectionToMoveTransformer<State> implements MoveTransformer<State, Direction> {
    ...
    /**
     * Offers transformation and reverse transformation of (State, Direction) <> ChessMove
     ...
     */
    @Override
    public ChessMove transform(State state, Direction source) {
        ...
        throw new IllegalArgumentException("ChessMove cannot be derived from Direction");
    }
     ...
     */
    @Override
    public Direction reverseTransform(ChessMove move) {
        ...
        throw new IllegalArgumentException("Direction cannot be derived from ChessMove");
    }
}
